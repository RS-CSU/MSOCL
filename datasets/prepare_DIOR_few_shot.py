...
#                'tvmonitor']
DIOR_CLASSES = ['dam', 'groundtrackfield', 'vehicle', 'windmill','Expressway-Service-area',
...
def generate_seeds(args):
    ...
    for year in ["DIOR"]:
        data_file = './datasets/{}/ImageSets/Main/trainval.txt'.format(year)
    ...
    for i in range(args.seeds[0], args.seeds[1]):
        ...
        save_path = './datasets/diorsplit/seed{}'.format(i)
