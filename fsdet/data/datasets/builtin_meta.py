...
DIOR_ALL_CATEGORIES = {
    ...
    2: ['dam', 'groundtrackfield', 'vehicle', 'windmill','Expressway-Service-area',
        'stadium', 'golffield', 'basketballcourt','ship', 'tenniscourt', 'trainstation',
        'Expressway-toll-station','baseballfield', 'overpass', 'harbor', 'bridge', 'airplane',
        'chimney', 'airport', 'storagetank'],
    3: ['dam', 'groundtrackfield', 'vehicle', 'windmill','Expressway-Service-area',
        'stadium', 'golffield', 'basketballcourt','ship', 'tenniscourt', 'trainstation',
        'Expressway-toll-station','baseballfield', 'overpass', 'harbor', 'bridge', 'airplane',
        'chimney', 'airport', 'storagetank'],
    4: ['dam', 'groundtrackfield', 'vehicle', 'windmill', 'Expressway-Service-area',
        'stadium', 'golffield', 'basketballcourt', 'ship', 'tenniscourt', 'trainstation',
        'Expressway-toll-station', 'baseballfield', 'overpass', 'harbor', 'bridge', 'airplane',
        'chimney', 'airport', 'storagetank'],
}
...
def _get_pascal_dior_fewshot_instances_meta():
    ret = {
...
def _get_builtin_metadata(dataset_name):
    if dataset_name == "coco":
        ...
        return _get_pascal_dior_fewshot_instances_meta()
