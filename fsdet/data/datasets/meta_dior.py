...
DIOR_BASE_CATEGORIES = {
    1: ['dam', 'groundtrackfield', 'vehicle', 'windmill','Expressway-Service-area',
        'stadium', 'golffield',  'tenniscourt', 'trainstation',
        'Expressway-toll-station','overpass', 'harbor',  'airplane',
          'airport', 'storagetank'],
    2: ['dam',  'vehicle', 'windmill','Expressway-Service-area',
        'stadium', 'golffield', 'basketballcourt','ship', 'tenniscourt', 'trainstation',
        'baseballfield', 'overpass',  'bridge',
        'chimney',  'storagetank'],
    3: ['groundtrackfield', 'windmill', 'Expressway-Service-area',
        'stadium', 'basketballcourt', 'ship', 'trainstation',
        'Expressway-toll-station', 'baseballfield', 'overpass', 'harbor', 'bridge', 'airplane',
        'chimney', 'airport'],
    4: ['dam', 'groundtrackfield', 'vehicle',
         'golffield', 'basketballcourt','ship', 'tenniscourt',
        'Expressway-toll-station','baseballfield',  'harbor', 'bridge', 'airplane',
...
def load_filtered_dior_instances(
    name: str, dirname: str, split: str, classnames: str):
    """
    Load Pascal dior detection annotations to Detectron2 format.
    ...
    if is_shots:
        for cls, fileids_ in fileids.items():
            ...
            for fileid in fileids_:
                year = "2012" if "_" in fileid else "DIOR"
            ...
            if use_more_base and cls in DIOR_BASE_CATEGORIES[int(split_id)]:
...
def register_meta_dior(
    ...
    DatasetCatalog.register(
        name, lambda: load_filtered_dior_instances(
